from ProductRegisters.BooleanLogic.Gates import AND, XOR
from ProductRegisters.BooleanLogic.Inputs import VAR, CONST
from ProductRegisters.Cryptanalysis.Components.EquationStores import DynamicEqStore, LUDynamicEqStore
...
#         f,subspace,annihilator_only,verbose
#     ):
